    ...
    <li class="nav-item {{ (request ()-> segment(1)== 'Utama')? 'active' :''}}">
        ...
        <div id="collapseTwo" class="collapse {{ (request ()-> segment(1)== 'Utama')? 'show' :''}}" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item {{ (request ()-> segment(1)== 'Utama')? 'show' :''}}" href="/Utama">Laman Utama</a>
                <a class="collapse-item {{ (request ()-> segment(1)== '#')? 'show' :''}}" href="#">Senarai</a>
                <a class="collapse-item {{ (request ()-> segment(1)== 'Borang')? 'active' :''}} " href="/Utama/Borang">Borang</a>
            </div>
        </div>
    </li>
